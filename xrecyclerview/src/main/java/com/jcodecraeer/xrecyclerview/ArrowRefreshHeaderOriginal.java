...
public class ArrowRefreshHeaderOriginal extends LinearLayout implements BaseRefreshHeader{
	...
	public ArrowRefreshHeaderOriginal(Context context) {
		super(context);
		initView(context);
	}
	 ...
	 * @param attrs
	 */
	public ArrowRefreshHeaderOriginal(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
