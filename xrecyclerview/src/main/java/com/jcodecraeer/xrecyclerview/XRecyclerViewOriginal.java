...
public class XRecyclerViewOriginal extends RecyclerView {
    ...
    public XRecyclerViewOriginal(Context context) {
        this(context, null);
    }

    public XRecyclerViewOriginal(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XRecyclerViewOriginal(Context context, AttributeSet attrs, int defStyle) {
